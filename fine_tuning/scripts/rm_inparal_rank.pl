...
use lib '/Users/zxwinner/Desktop/Tree_trimming';
use lauralib ;
use Bio::TreeIO;
use Bio::SearchIO; 
use Bio::SeqIO::fasta; 
...
#            print $sequence, "\n";
	...
	if($nb_removed > 0){
		...
		$commande = "/Users/zxwinner/Desktop/Tree_trimming/FastTree ".$out_align." > ".$inalign.".fasttree";
		print "\n\nTree reconstruction : \n",$commande,"\n";
		system `$commande`;
